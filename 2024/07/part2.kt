...
fun concatenate(a: java.math.BigInteger, b: java.math.BigInteger): java.math.BigInteger {
    // Could probably be improved with logarithms ?
    return BigInteger(a.toString() + b.toString());
}
...
fun isValid(target: java.math.BigInteger, values: List<java.math.BigInteger>, startAt: Int = 0, stacked: java.math.BigInteger = 0.toBigInteger()): Boolean {
    ...
    if (isValid(target, values, startAt+1, concatenate(stacked, head))) {
        return true;
    }
