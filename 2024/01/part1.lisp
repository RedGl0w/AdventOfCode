...
(defun sorted-input (filename)
  (mapcar #'(lambda (l) (sort l #'<)) (list-of-couple-to-couple-of-list (parse-file filename)))
)

(write (sum-difference (sorted-input "input.txt")))
